 ...
 */
@Service
public class DynamicRouteService implements ApplicationEventPublisherAware, ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        String routes = FileLoaderUtils.read("route.json");
        List<RouteDefinitionDTO> dtos = JSON.parseArray(routes, RouteDefinitionDTO.class);
        this.updateRoutes(dtos);
    }
}